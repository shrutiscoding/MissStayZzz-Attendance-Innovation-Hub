...
public class OutpassActivity extends AppCompatActivity {
    ...
    Spinner spncomm;
    String enroll,name,reason,address,outdate,outtime,indate,intime,remark,pmob,communication="";
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(OutpassActivity.this,OutpassesActivity.class);
    ...
    public void btnSubmitClick(View view)
    {
        ...
        pmob = etxtpmob.getText().toString().trim(); // Use getText from the button
        if (pmob.equals("")) {
            etxtpmob.setError("Please enter parent mobile number");
            etxtpmob.requestFocus();
            return;
        }
        pDialog = new ProgressDialog(OutpassActivity.this);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(OutpassActivity.this);

...
public class UpdateStudentActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(com.example.hostel_app.warden.UpdateStudentActivity.this,WardenStudentsActivity.class);
    ...
    public void btnUpdateClick(View view) {
        ...
        pDialog = new ProgressDialog(UpdateStudentActivity.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("success")) {
                                Intent intent = new Intent(UpdateStudentActivity.this, WardenStudentsActivity.class);
                                startActivity(intent);
                                finish();
                            } else {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(UpdateStudentActivity.this);

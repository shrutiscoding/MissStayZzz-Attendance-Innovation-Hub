...
public class UpdateOutpassActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_outpass2);
    ...
    private void showDatePicker(final Button button) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(com.example.hostel_app.officer.UpdateOutpassActivity.this,
    ...
    private void showTimePicker(final Button button) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(com.example.hostel_app.officer.UpdateOutpassActivity.this,
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(com.example.hostel_app.officer.UpdateOutpassActivity.this, com.example.hostel_app.officer.Officer_OutpassesActivity.class);
    ...
    public void btnUpdateClick(View view) {
        ...
        pDialog = new ProgressDialog(com.example.hostel_app.officer.UpdateOutpassActivity.this);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(com.example.hostel_app.officer.UpdateOutpassActivity.this);

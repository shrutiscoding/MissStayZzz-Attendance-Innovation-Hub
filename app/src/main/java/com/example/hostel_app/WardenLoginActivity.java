...
public class WardenLoginActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(WardenLoginActivity.this, MainActivity.class);
    ...
    public void btnLoginClick(View view) {
        ...
        pDialog = new ProgressDialog(WardenLoginActivity.this);
        pDialog.setMessage("Validating your details, please wait...");
        pDialog.setIndeterminate(false);
        pDialog.setCancelable(true);
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, DBClass.wardenLogin,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (loginSuccess) {
                                ...
                                query = "INSERT INTO Configuration(CName, CValue) ";
                                query += "VALUES('usertype', 'warden')";
                                DBClass.execNonQuery(query);

                                // Start the WardenHomeActivity
                                Intent intent = new Intent(WardenLoginActivity.this, WardenHomeActivity.class);
                                startActivity(intent);
                                finish();
                            } else {

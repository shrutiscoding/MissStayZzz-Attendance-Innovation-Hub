...
public class OfficerLoginActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(OfficerLoginActivity.this, MainActivity.class);
    ...
    public void btnLoginClick(View view) {
        ...
        pDialog = new ProgressDialog(OfficerLoginActivity.this);
        pDialog.setMessage("Validating your details, please wait...");
        pDialog.setIndeterminate(false);
        pDialog.setCancelable(true);
        pDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, DBClass.officerLogin,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (loginSuccess) {
                                ...
                                query = "INSERT INTO Configuration(CName, CValue) ";
                                query += "VALUES('usertype', 'officer')";
                                DBClass.execNonQuery(query);
                                // Start the WardenHomeActivity
                                Intent intent = new Intent(OfficerLoginActivity.this, OfficerHomeActivity.class);
                                startActivity(intent);
                                finish();
                            } else {

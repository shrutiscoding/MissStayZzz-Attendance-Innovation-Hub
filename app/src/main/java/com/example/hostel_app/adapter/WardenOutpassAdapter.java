...
public class WardenOutpassAdapter extends RecyclerView.Adapter<WardenOutpassAdapter.MyViewHolder>{
    ...
    public WardenOutpassAdapter(Context ctx, ArrayList<Outpass> outpassArrayList){
    ...
    @Override
    public WardenOutpassAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.outpass, parent, false);
        WardenOutpassAdapter.MyViewHolder holder = new WardenOutpassAdapter.MyViewHolder(view);
        return holder;
    }
    ...
    @Override
    public void onBindViewHolder(WardenOutpassAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        // Set background color based on the comparison
        if (datec <=  0) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtEn, txtName, txtaddress, txtreason, txtindate, txtintime;
            ...
            btnUpdate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        ...
                        Intent intent = new Intent(context,com.example.hostel_app.warden.UpdateOutpassActivity.class);

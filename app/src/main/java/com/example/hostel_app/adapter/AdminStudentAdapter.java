...
public class AdminStudentAdapter extends RecyclerView.Adapter<AdminStudentAdapter.MyViewHolder> {
    ...
    public AdminStudentAdapter(Context ctx, ArrayList<Student> studentArrayList){
    ...
    @Override
    public AdminStudentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.student, parent, false);
        AdminStudentAdapter.MyViewHolder holder = new AdminStudentAdapter.MyViewHolder(view);
        return holder;
    ...
    @Override
    public void onBindViewHolder(AdminStudentAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
